  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      try {
        ...
        console.error('침구류 상품 조회 실패:', err);
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="py-16 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">침구류</h1>
            <p className="text-lg text-gray-600">편안한 수면을 위한 침구류</p>
          </div>
        </div>
      </section>
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">침구류 상품</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">침구류 상품이 없습니다.</p>
            </div>
          )}
        </div>
      </section>
