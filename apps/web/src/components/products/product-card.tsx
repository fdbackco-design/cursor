        ...
        <CardContent className="flex-1 px-3 sm:px-4 pb-2 sm:pb-3 cursor-pointer">
          <div className="space-y-2 min-w-0">
            ...
            <div className="flex w-full min-w-0 items-start justify-between gap-2 sm:gap-2.5">
              ...
              <span
                className="min-w-0 max-w-[72%] break-words text-right text-[14px] font-extrabold tabular-nums leading-snug text-[#FF6F0F] [overflow-wrap:anywhere] sm:max-w-[75%] sm:text-[15px]"
              >
                {priceDisplay.price ? (
                  priceDisplay.price
                ) : (
